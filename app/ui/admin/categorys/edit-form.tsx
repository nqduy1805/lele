...
import { CategoryField, ProductForm } from '@/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
import { updateProduct, State } from '@/lib/actions';
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500" maxLength={5000} defaultValue={product.name} name="name"  placeholder="Nhập tên sản phẩm" type="text"  required />
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                step="1"
                placeholder="Enter USD price_sale"
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={product.is_sale === 'false'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  defaultChecked={product.is_sale === 'true'}
                  className="h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="paid"
