...
export default async function Home({
  ...
  return (
    <div className="flex flex-col justify-start items-center h-full border rounded-[10px] transition-colors duration-200  border-dark-beige relative overflow-hidden pb-[15px]">
        <Link className=" h-full " href={product.href}>
            ...
            <h3 className="text-[24px] text-dark-beige font-normal leading-[110%] my-2.5">
                {product.title}
            </h3>
            <p className="font-light text-light-beige">{product.descript}</p>
            </div>
        </Link>
