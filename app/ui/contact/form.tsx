    ...
    return (
        <div className="border border-dark-beige rounded-[10px] p-[3vw] rounded-[10px]" >
            ...
            <form className='flex justify-center flex-col pt-[30px]'>
                <input className="focus:outline-none mb-[10px] rounded-[5px] border border-gray-300" maxLength="255" name="email" data-name="Email" placeholder="please enter your name" type="text"  required />
                <input className="focus:outline-none mb-[10px] rounded-[5px] border border-gray-300" maxLength="255" name="email" data-name="Email" placeholder="please enter your email" type="email" required />
